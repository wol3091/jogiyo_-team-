...
public class MemberController {
	...
	public ModelAndView myPage(HttpServletRequest request) throws IOException{
		...
		for (Owner_orderlistDTO owner_orderlistDTO : list) {
			...
			ch_owner_orderlistDTO.setDelivery_region(requestDTO.getSeq());
			...
			ch_owner_orderlistDTO.setReview(owner_orderlistDTO.getReview());
			...
			review = owner_orderlistDTO.getReview();
		...
		session.setAttribute("cl_memId", id);
	...
	public ModelAndView logout(HttpServletRequest request) {
		...
		session.removeAttribute("cl_memId");
