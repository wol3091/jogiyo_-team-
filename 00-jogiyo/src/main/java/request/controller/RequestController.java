...
//			modelAndView.setViewName("redirect:../../owner/ownermain/ownermain.jsp");
	   ...
	   //정보수정 -공지사항
		...
		public ModelAndView  requestResult(HttpServletRequest request, RequestDTO requestDTO, MultipartFile image
			...
			String filePath1 = "C:\\Users\\Owner\\Downloads\\프로젝트\\workspace\\00-jogiyo\\src\\main\\webapp\\storage\\registration\\";
		    String filePath2 = "C:\\Users\\Owner\\Downloads\\프로젝트\\workspace\\00-jogiyo\\src\\main\\webapp\\storage\\business_register\\";
		    String filePath3 = "C:\\Users\\Owner\\Downloads\\프로젝트\\workspace\\00-jogiyo\\src\\main\\webapp\\storage\\somename\\";
	   ...
	   @RequestMapping(value="owner/signup/ownerPolicy.do")
	   public ModelAndView ownerPolicy() {
	        ModelAndView modelAndView = new ModelAndView();
	        modelAndView.addObject("display","../../owner/signup/ownerPolicy.jsp");
	        modelAndView.setViewName("../../owner/ownermain/ownermain.jsp"); 
	        return modelAndView;
	   }
	 ...
	 //매출 그래프 이동
	   @RequestMapping(value="owner/menumanagement/ownerGraph.do")
	   public ModelAndView ownerGraph(HttpServletRequest request) {
	        ...
	        String [] day_s = new String[12];
	        String [] day_pofit = new String[12];
	        
	        for (int i = 0; i < 12; i++) {
	        	Date d = new Date();
	        	OrderlistDTO orderlistDTO = new OrderlistDTO();
	        	d.setTime ( today.getTime ( ) - ( (long) 1000 * 60 * 60 * 24*i ) );
	        	SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
	        	SimpleDateFormat sdf2 = new SimpleDateFormat("MM-dd");
	        	
	        	
	        	orderlistDTO.setCeo_seq(seq);
		        orderlistDTO.setLogtime(sdf.format(d));
		        
		        String total = orderlistService.dayProfit(orderlistDTO);
		        if(total == null) {
		        	total="0";
		        }
		        day_pofit[i] = total;
		        day_s[i] = sdf2.format(d);
		        
		        System.out.println(day_s[i]+" : "+day_pofit[i]);
		        
			}
	        
	        List<OrderlistDTO> list = new ArrayList();
	        list = orderlistService.propitByMenu(seq);
	        
	        
	        
	        ModelAndView modelAndView = new ModelAndView();
	        modelAndView.addObject("day_pofit",day_pofit);
	        modelAndView.addObject("day_s",day_s);
	        modelAndView.addObject("list",list);
	        
	        modelAndView.addObject("display","../../owner/menumanagement/ownerGraph.jsp");
	        modelAndView.setViewName("../../owner/ownermain/ownermain.jsp"); 
	        return modelAndView;
	   }
