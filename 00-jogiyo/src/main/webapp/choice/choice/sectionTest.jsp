...
<div id="sectionTest1" >
	...
	<span style="color: #6e6e6e;"><br>음식점 ${sum}곳을 찾았습니다.</span>
...
<div id="sectionTest2">
				...
				<tr  style="cursor: pointer;" onclick="movingView('${requestDTO.getSeq()}');">
					...
					<td style="width: 100%;">
						<ul>
							...
							<li> 
							<c:if test="${requestDTO.getRestaurant_phone1() == null}">	
			                	리뷰를 작성해 주세요!${requestDTO.getRestaurant_phone1()}
			               	</c:if>
			               
			               	<c:if test="${requestDTO.getRestaurant_phone1() != null}">	
			                	<span style="color: orange;">★ </span> ${requestDTO.getRestaurant_phone1()}  | <span style="color: #646464">리뷰 ${requestDTO.getRestaurant_phone2()} </span>
			               	</c:if>
							</li>
							...
							<li style="float: right; color: #646464">${requestDTO.getDelivery_time()}분</li>
						</ul>
					</td>
				</tr>
			</table>
	...
	<div id="list_star">
	<span style="color: red; font-size: 10px;">리뷰가 없는 음식점은 제외됩니다.</span><br>
