...
$(document).ready(function() {
	...
	if(".reviewpoint > ${reviewDTO.starpoint }" == 1) {
		$("div.reviewpoint").html("★☆☆☆☆");
	};
	if(".reviewpoint > ${reviewDTO.starpoint }" == 2) {
		$("div.reviewpoint").html("★★☆☆☆");
	};
	if(".reviewpoint > ${reviewDTO.starpoint }" == 3) {
		$("div.reviewpoint").html("★★★☆☆");
	};
	if(".reviewpoint > ${reviewDTO.starpoint }" == 4) {
		$("div.reviewpoint").html("★★★★☆");
	};
	if(".reviewpoint > ${reviewDTO.starpoint }" == 5) {
		$("div.reviewpoint").html("★★★★★");
	};
	...
	<c:forEach var="reviewDTO" items="${reviewlist}">
			<ul class="review-ul">
				...
				<li class="review-li review-image">
					...
					<c:if test="${reviewDTO.image != null }">
						<img src="../storage/review/${reviewDTO.image}" onerror="this.src='../storage/review/no.png'" width=200px; height=100px;>
					</c:if>
				</li>
			...
			<c:if test="${reviewDTO.ceoOK == 'y'}">
			<ul class="review-ul review-ul-owner">
				<li class="review-li owner-review">
					<img src="../image/comment_indicator.png" style="width: 10px; height: 10px;">&nbsp;&nbsp;<span style="font-weight: bold;">사장님</span>&nbsp;${reviewDTO.logtimeCeo }
				</li>
				<li class="review-li owner-review">${reviewDTO.ceoContent }</li>
			</ul>
			</c:if>
