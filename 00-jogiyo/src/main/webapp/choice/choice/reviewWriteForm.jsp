...
<input type="hidden" name="logtime" value="${logtime }">
	<div class="container">
		...
		<ul class="review-ul">
			<li class="review-li">
				<label>${ceo_seq2} - ${logtime}</label><br>
				<span class="nickname">${memName}&nbsp;님&nbsp;&nbsp;</span>
			</li>
			<li class="review-li starp">
				<label>별점 : </label>
				<input type="radio" name="starpoint" id="star1" value="1"><label for="star1">★</label>&nbsp;
				<input type="radio" name="starpoint" id="star2" value="2"><label for="star2">★★</label>&nbsp;
				<input type="radio" name="starpoint" id="star3" value="3"><label for="star3">★★★</label>&nbsp;
				<input type="radio" name="starpoint" id="star4" value="4"><label for="star4">★★★★</label>&nbsp;
				<input type="radio" name="starpoint" id="star5" value="5" checked><label for="star5">★★★★★</label><br>
			</li>
			<li class="review-li order">
				${food}
			</li>
			<li>
				<input type="file" id="image" name="imageFile" accept=".gif, .jpg, .png">
			</li>
