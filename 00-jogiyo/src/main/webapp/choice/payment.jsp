...
<script type="text/javascript">
	...
	function go_realOrder() {
		...
		} else if(!$("#accessCheck").is(":checked")) {
			alert("요기요 이용약관에 동의 해주세요");
			$("#accessCheck").focus();
		} else if(!$("#privacyCheck").is(":checked")) {
			alert("개인정보 수집 및 이용에 동의 해주세요");
			$("#privacyCheck").focus();
		} else if(!$("#privacyAgreeCheck").is(":checked")) {
			alert("개인정보 제3자 제공에 동의 해주세요");
			$("#privacyAgreeCheck").focus();
		} else {
...
<div id="section">
	<div id="real_section">
		<div id="real_section_part1">
			...
			<div style="height: 210px; width: 100%; border: 1px solid #dcdcdc; border-top: none; border-bottom:none;
			padding-left: 0.1px;" class="btn_address_area">
				<table style="width: 100%; padding-top: 20px;">
					<tr style="width: 100%; height: 40px;">
						<td style="width: 20%; text-align: right; padding-right: 20px; font-weight: bold;">주소(서울한정)</td>
						<td style="width: 65%;"><input type="text" name="first_address" value="서울" readonly="readonly"
			...
			<div class="subject_tg" style="border-top: 0.1px solid #a0a0a0;"  onclick="req_btn();">
				...
				<div style="height: 180px;  width: 100%; border: 1px solid #dcdcdc; border-top: none; border-bottom: none;" class="btn_textarea">
					...
					<input type="hidden" name="id" value="${cl_memId }">
			...
			padding-left: 10px;">
				...
				<table style="width: 95%; height: 40px; margin: auto;  margin-top: 10px; border: 1px solid #dcdcdc;">
					<tr>
						<td style="border-right: 1px solid #dcdcdc; border-left: none;"><input type="radio" name="calc_choice" checked>신용카드 결제</td>
						<td><input type="radio" name="calc_choice">휴대전화 결제</td>
					</tr>
				</table>
			</div>
			...
			<div style="height: 70px; width: 100%; border: 1px solid #dcdcdc; border-top: none; padding-left: 0.1px;">
...
border-bottom: none; color: #5a5a5a;padding-top: 5px; padding-left: 10px;">
				주문 내역
			</div>
			<div style="width: 100%; background: white; height: 30px; border: 1px solid #a0a0a0;
border-bottom: none; color: black; padding-top: 5px; padding-left: 10px;">
...
border-bottom: none; color: black;padding-top: 12px; padding-left: 10px; padding-bottom: 12px;">
 ...
 color: black;padding-top: 30px; padding-left: 10px; font-size: 15px; font-weight: bold;">
			...
			<div style="width: 100%; color: black;padding-top: 2px; padding-left: 20px;">
 				<input type="checkbox" style="width: 20px; height: 20px;" name="all_ch" id="smsCheck">
				<div style="display: inline-block;position: relative; top:-5px;  font-size: 12px; font-weight: bold;">SMS 수신 동의</div><br>
				
				<input type="checkbox" style="width: 20px; height: 20px;" name="all_ch" id="accessCheck">
				<div style="display: inline-block;position: relative; top:-5px;  font-size: 12px; font-weight: bold;">요기요 이용약관에 동의합니다. (전문보기)</div><br>
				
				<input type="checkbox" style="width: 20px; height: 20px;" name="all_ch" id="privacyCheck">
				<div style="display: inline-block;position: relative; top:-5px;  font-size: 12px; font-weight: bold;">개인정보 수집 및 이용에 동의합니다. (전문보기)</div><br>
				
				<input type="checkbox" style="width: 20px; height: 20px;" name="all_ch" id="privacyAgreeCheck">
