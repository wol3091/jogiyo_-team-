...
<div class="header"> 
	...
	<div class="left">
	<a href="#" onclick="isLogin1()"><img style="margin-left: 750px;" class="approve" src="../../owner/ownerimage/approve.PNG" width="150px"></a> 
	</div>
	<div class="left">
...
<div class="footer">
  <div class="footer-menu">
    <ul>
	  ...
	  <li><a href="../../owner/ownermain/ownermain.do">사장님 사이트</a></li>
	  <li><a href="../../main/index.do">조기요 사이트</a></li>
<!--       <li class="sns-link">
