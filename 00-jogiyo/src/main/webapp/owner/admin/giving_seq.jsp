...
<form id="seqForm" name="seqForm" method="post" action="seqResult.do?preseq=${preseq}">
        <div class="section-box">
          <h3 class="tit">음식점 관리번호 부여</h3>
              <div class="row-field">
                <div class="input-area">
                  <input onchange="change_ck();" type="text" class="input"  name="seq" id="seq" maxlength="6" placeholder="부여할 seq 6자리를 입력주세요" required="required">
          ...
          <div class="btn-wrap">
          	<input type="button" class="btn" value="확인" onclick="check_ty()">
          </div>
