...
$(function(){
	if (location.hash == "#home"){
		...
		$('.tab-content').find('#home').addClass('active in').siblings().removeClass('active in');
		...
		$('.tab-content').find('#messages').addClass('active in').siblings().removeClass('active in');
	} 
})
*/
</script>
...
<ul class="nav nav-tabs" role="tablist" id="myTab">
  <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab" class="font">이용약관</a></li>
  <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab" class="font">개인정보 처리방침</a></li>
  <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab" class="font">개인정보 제3자 제공동의</a></li>
  <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab" class="font">위치기반 서비스 이용약관</a></li>
</ul>

<div class="tab-content">
  <div role="tabpanel" class="tab-pane active" id="home">
  <h3 class="h3">요기요 이용약관</h3>
  <p><textarea rows="100" cols="150" readonly="readonly">
제1조 (목적)
...
부칙
[제1조] 본 약관은 2018년 1월 8일에 개정되었으며, 2018년 2월 7일부터 시행됩니다.</textarea></p>
  </div>
...
수탁업체	위탁업무 내용
㈜케이지이니시스, ㈜카카오페이, (주)한국사이버결제, NHN 엔터테인먼트㈜	전자결제 수단 제공
㈜케이지모빌리언스	본인확인
...
- 시행일자 : 2018.07.12.
  ...
  <h3 class="h3">개인정보 제 3자 제공동의</h3>
  <p><textarea rows="30" cols="150" readonly="readonly">
  제1조 (목적)
...
4. 대표전화: 02-3447-3612
부칙
제 1조 (시행일) 이 약관은 2017년 11월 6일부터 시행한다.
...
$(document).ready(function() {
  var showTip = function (tab) {
    var elem = $('a[href='+tab+']');
    if (elem.length>0) {
      $(tab).show().siblings().css("display", "none");
      $(elem).parent().addClass("current").siblings().removeClass("current");
      var frame = $(tab).find('iframe');
      if (frame.length>0) {
        frame.height(frame[0].contentDocument.body.clientHeight);
      }
    }
  };

  showTip(location.hash);
  ...
  $('.select1').on('change', function() {
    if (this.value.indexOf('.html') > 0) {
      $('#tab-1>iframe').attr('src', this.value);
      window.scrollTo(0,0);
    }
  });
  $('.select2').on('change', function() {
    if (this.value.indexOf('.html') > 0) {
      $('#tab-2>iframe').attr('src', this.value);
      window.scrollTo(0,0);
    }
  });
