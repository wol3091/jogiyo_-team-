...
function checkLogin() {
	...
	} else if(document.searchIdForm.business_phone3.value == "") {
...
<form action="searchId.do" name="searchIdForm" method="post">
	...
	<div class="container">
		...
		<br>
	    <input type="button" onclick="javascript:checkLogin()" id="btn" class="btn btn-lg btn-danger btn-block" value="아이디 찾기">
	    <br><br>
    </div>
    </div>
</form>
