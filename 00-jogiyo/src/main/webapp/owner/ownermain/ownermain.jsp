...
function isLogin9() {
	...
	<c:if test="${sessionScope.memId != null}">
		location.href="../../owner/menumanagement/ownerGraph.do";
	</c:if>
}
...
<a href="../../owner/ownermain/ownermain.do"><img class="text-center" src="../../owner/ownerimage/logoowner.png" style="width: 250px;" ></a >
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
	          ...
	          <ul class="dropdown-menu">
	            ...
	            <li><a href="#" onclick="isLogin9()">업소통계</a></li>
	            <li><a href="#" onclick="isLogin8()">주문확인</a></li>
	          </ul>
	        </li>
	        <li class="dropdown">
		...
		<ul>
			<li class="collapsible">
				...
				<ul>
					...
					<li class="content"><a href="#" onclick="isLogin9()">업소통계</a></li>
					<li class="content"><a href="#" onclick="isLogin8()">주문확인</a></li>
				</ul>
			</li>
		</ul>
		<ul>
...
<!-- 			<input id="id" name="id" type="text" placeholder="아이디 입력"><br>
			...
			<div id="container3">
				<div class="other"><img id="application" alt="" onclick="location.href='../../owner/signup/placementProcedure.do'" src="../../owner/ownerimage/procedure.PNG"></div>	
				<div class="other"><img id="agreement" alt="" src="../../owner/ownerimage/application.png"></div>
				<div class="other"><img id="anything" alt="" onclick="location.href='../../owner/signup/ownerPolicy.do'" src="../../owner/ownerimage/application.png"></div>
			</div>
		</div>
	</div>
</c:if>
