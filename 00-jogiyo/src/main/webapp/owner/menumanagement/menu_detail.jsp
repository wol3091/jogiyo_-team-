...
<div class="contents-area">
	...
	<div class="edit-menu-detail">
		...
		<div>
			<c:if test="${menu_group == ownerMenuDTO.menu_group}">
			<img src="../../storage/imgName/${ownerMenuDTO.imgName}" style="margin-left: 150px;" width="200px" height="200px">
			</c:if>	
			<c:if test="${menu_group == ownerSideMenuDTO.menu_group}">
				<img src="../../storage/imgName/${ownerSideMenuDTO.imgName}" style="margin-left: 150px;" width="200px" height="200px">
			</c:if>		
		</div>	
			...
			<div>
				...
				<ul class="option-list price-set">
					...
					<li>
						<div class="input-wrap">
							<c:if test="${menu_group == ownerMenuDTO.menu_group}">
								<input type="text" name="price" style="margin-left:350px; width: 130px;" lang="en-150" type="tel" placeholder="5,000" value="${ownerMenuDTO.price}">
			...
			<div class="addmenu">
				<ul class="option-list">
					...
					<c:forEach var="ownermenuDTO" items="${list3}">
							<li>
								<input disabled="disabled" type="text" name="addmenu" value="${ownermenuDTO.addmenu}" style="background:#fff;" class="item">
							  	<input disabled="disabled" type="text" name="addmenu_price" value="${ownermenuDTO.addmenu_price}" style="background:#fff;" class="option-price">
							</li>
					</c:forEach>
						<li>
