			                ...
			                <!--    <form action="" name="commentForm" method="post"> -->
						            ...
						            <div>
						                <table>                    
						                    <tr>
						                        <td>
						                       <textarea readonly="readonly"  name="menu_explain" id="menu_explain" cols="30" rows="7" style="width:500px; overflow:auto; background: #fff; " maxlength="500 " class="content1">${reviewDTO.getCeoContent()}</textarea>
						                        </td>
						                    </tr>
						                </table>
						            </div>
						        ...
						        <div id="${reviewDTO.getReview_seq()}">
			               			<div class="owner_u" onclick="toggle_ow('${reviewDTO.getReview_seq()}');" style="cursor: pointer;">
								                     ...
								                     <form action="owner_answer.do" name="answer" method="post">
								                        <textarea name="ceoContent" id="menu_explain" cols="30" rows="7" style="width:500px; overflow:auto; background: #fff; " maxlength="500 " class="content1">
								                            ...
								                            <div>
								                                ...
								                                <input type="button" class="btn btn-default" onclick="toggle_om('${reviewDTO.getReview_seq()}');" style="float:right;" value="작성 취소">
								                            </div>
								                      </form> 
								                  </td>
