...
function add() {
	if($("input[name=menu_group]").val() == "") {
		alert("메뉴그룹을 선택하세요.");
		$("input[name=menu_group]").focus();
	...
	}  else if($("input[id=imgName]").val() == "") {
		alert("이미지를 선택하세요.");
		$("input[id=imgName]").focus();
	} else {
...
<div class="content-area">
   <form name="addMenu" id="addMenu" action="menu_addResult.do" method="post" enctype="multipart/form-data">
      <div class="addmenu">
      ...
      <div class="filebox">
      	...
      	<input class="upload-hidden" type="file" accept=".gif, .jpg, .png" name="image" id="imgName">
      </div>
      <div class="add-btn-area">
            <button class="btn-cancel" type="button">취소</button>
            <button class="btn-save" type="button" onclick="javascript:add()">추가</button>
         </div>
   </form>
</div>
</body>
