...
<div id="header">
	<div>
		<a href="../main/"><img id="logo" src="../image/logo.png" alt="조기요" width="150" height="80"></a>
	</div>
	<div>
	<c:if test="${cl_memId == null }">
...
<c:if test="${choice == 1 }">
	<div class="search2" style=" padding: 50px 100px 35px 100px; background-image: url(../image/20180918-1.png); background-size: cover;">
		<input type="search" class="search-form-control" data-placement="bottom" data-toggle="tooltip"
	         id="testtest" title="배달할 주소를 입력하세요." placeholder="예) 역삼동,봉천동" style="margin-top: -80px;" value="${location}">
	    <span id="button_search_address" class="input-group-btn always-show-search-buttons "
	...
	<div class="footer-menu">
		<ul>
			...
			<li class="mb privacy-txt">
				<a href="../policy/policy.do">개인정보처리방침</a>
			</li>
			<li class="mb cscenter">
				<a href="#">통합포인트정책(추가예정)</a>
			</li>
			<li>
				<a href="https://rgpkorea.recruiter.co.kr" target="_blank">채용정보</a>
			</li>
			<li>
				<a href="http://localhost:8080/00-jogiyo/owner/ownerLogin/ownerLoginForm.do" target="_blank">조기요사장님</a>
			</li>
			<li class="mb lst">
				<a href="http://localhost:8080/00-jogiyo/owner/signup/requestForm.do" target="_blank">입점문의</a>
			</li>
			<li class="mb notice">
